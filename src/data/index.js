...
export const FAQS = [
  ...
  { q: 'How can I become a sponsor?', a: 'Contact the organizing committee at ieee.tr@socet.edu.in We offer Title, Platinum, Gold, Silver, and Community partnership tiers.' },
];

export const CONTACT_ITEMS = [
  { icon: '✉️', label: 'Email', value: 'ieee.tr@socet.edu.in' },
  { icon: '📍', label: 'Venue', value: 'EA - 820 IEEE Workspace, Silver Oak University, Ahmedabad' },
  { icon: '🗓️', label: 'Date', value: '21 July 2026' },
  { icon: '📞', label: 'Contact', value: '+91 63524 74784, +91 79908 15230' },
];
