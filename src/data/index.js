...
export const REG_TIERS = [
  { type: 'Student',      price: '299',  symbol: '₹', note: 'General Admission',      featured: false, cta: 'Register →' },
  { type: 'IEEE Member',  price: '199',  symbol: '₹', note: 'Student IEEE Members',   featured: true,  cta: 'Register →' },
  { type: 'Professional', price: '599',  symbol: '₹', note: 'Industry Professionals', featured: false, cta: 'Register →' },
  { type: 'Speaker',      price: 'Free', symbol: '',  note: 'Complimentary Access',   featured: false, cta: 'Apply →'    },
];
