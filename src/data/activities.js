export const ACTIVITIES = [
    ...
    { icon: '🎤', title: 'Questions And Discussions', desc: 'Ask questions directly to our expert panel AI futures, industry trends, ethics, career guidance and entrepreneurship.' },
];
