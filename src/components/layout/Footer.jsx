...
export default function Footer() {
 ...
 <div
 className="absolute bottom-0 w-full left-1/2 -translate-x-1/2 translate-y-[8%] select-none pointer-events-none z-0 text-white font-sora font-extrabold tracking-wider opacity-10 leading-none uppercase text-center whitespace-nowrap"
