...
export default function RegistrationSection() {
 ...
 className="px-10 py-3.5 sm:px-12 sm:py-4 rounded-xl text-[14px] sm:text-[15px] font-bold transition-all duration-300 flex items-center justify-center gap-2 bg-transparent border border-accent/40 text-accent hover:bg-accent/10 hover:border-accent/70 hover:scale-[1.02]"
 >
 Register Now →
 </button>
 </div>
