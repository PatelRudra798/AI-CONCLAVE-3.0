...
const BADGE_STYLES = {
    ...
    panel: { label: 'Activity', cls: 'bg-accent/20 text-accent border-accent/45' },
    break: { label: 'Activity', cls: 'bg-accent/10 text-accent border-accent/25' },
    refreshments: { label: 'Refreshments', cls: 'bg-accent/10 text-accent border-accent/25' },
                ...
                >
                    ...
                    <div className="relative p-4 md:p-3.5 flex flex-col justify-center gap-1">
                        ...
                        <div className={`flex items-center gap-1.5 flex-wrap justify-start`}>
                            ...
                            {b && (
                                <span className={`max-[390px]:hidden text-[9px] md:text-[8px] font-bold px-1.5 py-0.5 rounded-full border ${b.cls} ml-auto`}>
                                    {b.label}
                                </span>
                            )}
                        </div>
                        ...
                        {/* Speaker tag */}
                        {item.speaker && (
                            <p className="text-[10px] text-accent2-light font-medium mb-1 text-left"></p>
                        )}
