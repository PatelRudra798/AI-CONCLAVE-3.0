                        ...
                        <div style={{ position: 'relative', height: `${690 * scale * 0.85}px`, width: `${360 * scale * 0.85}px` }}>
                            <div style={{ transform: `scale(${scale * 0.85})`, transformOrigin: 'top left', position: 'absolute', top: 0, left: 0 }}>
                                ...
                                >
                                    ...
                                    {photo && (
                                        <>
                                            {/* PARAMETERS FOR PHOTO PLACEMENT AND SIZE ARE HERE: 
                                                    left-[180px] controls the horizontal (X-axis) position. Increase to move right, decrease to move left.
                                                    top-[174px] controls the vertical (Y-axis) position.
                                                    w-[232px] h-[245px] controls the size of the circle. 
                                                */}
                                            <div className="absolute left-[178px] top-[174px] -translate-x-1/2 w-[232px] h-[245px] rounded-full overflow-hidden flex items-center justify-center z-10 shadow-lg">
